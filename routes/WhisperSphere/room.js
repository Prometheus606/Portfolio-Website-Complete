...
router.get("/:id", async (req, res) => {
    if (!req.isAuthenticated()) {
        ...
        return res.redirect("/whispersphere")
    }
    ...
    try {
        ...
        res.render("WhisperSphere/room", params)
...
router.post("/create", async (req, res) => {
    ...
    try {
        ...
        res.render("WhisperSphere/newRoom", {
            success: true,
...
router.post("/delete-message", async (req, res) => {
    ...
    try {
        await db.query("DELETE FROM whisper_sphere_messages WHERE id=$1", [messageID])
...
router.post("/delete", async (req, res) => {
    ...
    try {
        ...
        res.render("WhisperSphere/index", {
