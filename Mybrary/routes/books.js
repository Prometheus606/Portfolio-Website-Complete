...
const {saveCover, BinaryToImage} = require("../pictureHandler")
...
router.get("/new", async (req, res) => {
    ...
    res.render("books/new", {book: emptyBook, authors})
})
...
router.post("/", async (req, res) => {
    ...
    try {
        ...
        res.render("books/new", {book, errorMessage: "Error Creating Book", authors})
    }
})
...
router.get("/:id", async (req, res) => {
    ...
    try {
        ...
        res.render("books/view", {book, author});
    } catch (error) {
        console.error(error);
...
router.put("/:id", async (req, res) => {
    ...
    try {
        ...
        result = await db.query("SELECT * FROM mybrary_authors")
        const authors = result.rows
        res.status(500).render("books/new", {book, errorMessage: "Error Updating Book", authors})
    }
});
